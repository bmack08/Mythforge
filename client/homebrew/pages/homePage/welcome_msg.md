...
# Mythwright *AI-Powered D&D Generator*
Welcome, Dungeon Master! Ready to craft epic adventures without the endless hours of preparation? Mythwright combines the power of AI with authentic D&D styling to generate complete sourcebooks, adventures, and homebrew content tailored to your campaign.

### AI-Generated D&D Content Made Easy
Mythwright uses advanced AI to generate complete D&D sourcebooks based on your campaign parameters. Simply answer a few questions about your party, difficulty preferences, and themes, and watch as Mythwright creates authentic-looking Fifth-Edition content using [Markdown](https://help.github.com/articles/markdown-basics/) with beautiful D&D styling.
...
Mythwright offers two modes: AI Generation and Manual Editing. AI Generation is recommended for busy DMs who want complete sourcebooks generated automatically based on campaign parameters. Manual Editing mode gives you full control over every detail, perfect for fine-tuning AI-generated content or creating from scratch.
...
### Mythwright Features
Ready to revolutionize your D&D prep? Mythwright offers:
- **AI Campaign Questionnaire** - Answer questions about your party and preferences
- **Intelligent Content Generation** - Complete adventures, NPCs, items, and lore
- **Multi-Chapter Sourcebooks** - Organized, professional-looking books
- **Authentic D&D Styling** - Looks like official WotC content
...
### Legal Information
Mythwright is built upon The Homebrewery (MIT License) and adds AI-powered content generation capabilities. All generated content is yours to use commercially or personally.

**Important**: While Mythwright generates content, you're responsible for ensuring your final products comply with Wizards of the Coast's Fan Content Policy and any applicable licenses for images or resources used.

#### Attribution
Mythwright is powered by advanced AI and built on The Homebrewery foundation. When sharing your creations, you're welcome to mention they were "Generated with Mythwright" - we'd be honored!
