...
const GoogleActions = {
    authCheck: (account, res, updateTokens = true) => {
        ...
        const oAuth2Client = new googleDrive.auth.OAuth2(config.get('google_client_id'), config.get('google_client_secret'), '/auth/google/redirect');
...
//# sourceMappingURL=googleActions.js.map