...
let models = null;
const initializeModels = async (config) => {
    // Connect to database
    const sequelize = await database.connect(config);
...
const setupAssociations = ({ Project, Chapter, Section, Encounter, StatBlock, MagicItem, NPC, Template, Version }) => {
