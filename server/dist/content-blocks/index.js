...
export const TextBlockDefinition = {
    ...
    renderer: (content) => {
        ...
        let markdown = text;
        // Apply formatting
        if (formatting.style === 'italic')
            markdown = `*${markdown}*`;
        if (formatting.style === 'bold')
            markdown = `**${markdown}**`;
        if (formatting.style === 'emphasis')
            markdown = `***${markdown}***`;
...
// ============================================================================
export const BoxedTextBlockDefinition = {
    type: 'boxedtext',
    name: 'Boxed Text',
...
// ============================================================================
export const SidebarBlockDefinition = {
    type: 'sidebar',
    name: 'Sidebar',
...
// ============================================================================
export const StatBlockContentDefinition = {
    type: 'statblock',
    name: 'Stat Block',
...
export const ImageBlockDefinition = {
    ...
    renderer: (content) => {
        ...
        let classes = ['image'];
        if (layout !== 'inline')
            classes.push(`image-${layout}`);
        if (size !== 'medium')
            classes.push(`image-${size}`);
        if (border)
            classes.push('image-border');
        if (shadow)
            classes.push('image-shadow');
        let markdown = '';
        if (layout === 'center') {
            markdown += `<div style="text-align: center">\n\n`;
        }
...
// ============================================================================
export const HandoutBlockDefinition = {
    type: 'handout',
    name: 'Handout',
    ...
    renderer: (content) => {
        ...
        if (aged)
            classes.push('handout-aged');
        if (torn)
            classes.push('handout-torn');
        if (stained)
            classes.push('handout-stained');
        if (font !== 'normal')
            classes.push(`handout-${font}`);
...
// ============================================================================
export const ContentBlockRegistry = {
...
export class ContentBlockProcessor {
    ...
    static validateBlock(type, content) {
    ...
    static renderBlock(type, content, metadata) {
        const definition = this.getBlockDefinition(type);
        if (!definition) {
    ...
    static createDefaultBlock(type) {
        const definition = this.getBlockDefinition(type);
        if (!definition) {
...
export class ContentBlockBuilder {
    blocks = [];
    addBlock(type, content, metadata) {
